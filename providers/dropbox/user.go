...
const (
	dropboxKeyID       string = "uid"
	dropboxKeyName     string = "display_name"
	dropboxKeyNickname string = "display_name"
)
...
// NewUser builds a new User object for Dropbox.
func NewUser(data objx.Map, creds *common.Credentials, provider common.Provider) *User {
	user := &User{data}

	creds.Set(common.CredentialsKeyID, data[dropboxKeyID])
...
func (u *User) Name() string {
	return u.Data().Get(dropboxKeyName).Str()

}

// Nickname gets the users nickname or username.
func (u *User) Nickname() string {
	return u.Data().Get(dropboxKeyNickname).Str()

}

// Dropbox API doesn't return email
